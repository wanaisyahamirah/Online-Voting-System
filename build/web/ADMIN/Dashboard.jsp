<%-- 
    Document   : Dashboard
    Created on : Jul 7, 2021, 11:15:26 AM
    Author     : USER
--%>
...
<html lang="en">
    <head>
        ...
        <title>Admin Dashboard | Voting Rush</title>
                ...
                <main class="w-full flex-grow p-6">
                    ...
                    <div class="w-full mt-12">
                        <p class="text-xl pb-3 flex items-center">
                            <i class="fas fa-list mr-3"></i> Organization Lists
                        </p>
                                    ...
                                    <tr>
                                        <td class="px-5 py-5 border-b border-gray-200 bg-white text-sm">
                                            <div class="flex items-center">
                                                <p class="text-gray-900 whitespace-no-wrap">
                                                    <a class="hover:text-blue-500 hover:underline" href="OrgDetails.jsp?id=<%=org.getOrganizationId()%>"><%=org.getOrganizationName()%></a>
                                                </p>
                                            </div>
                                        </td>
                                        <td class="px-5 py-5 border-b border-gray-200 bg-white text-sm">
                                        ...
                                        <td class="px-5 py-5 border-b border-gray-200 bg-white text-sm">
                                            <div class=" flex justify-between">
                                                <a href="OrgDetails.jsp?id=<%=org.getOrganizationId()%>" class=" flex items-center px-4 py-1 text-white font-light tracking-wider bg-gray-900 rounded hover:bg-gray-700" type="submit">
                                                ...
                                                <form action="<%=request.getContextPath()%>/adController" method="POST">
                                                    <input type="hidden" name="organizationid" value="<%=org.getOrganizationId()%>">
