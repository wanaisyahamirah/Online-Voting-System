<%-- 
    Document   : EventPollResult
    Created on : Jun 5, 2021, 1:32:23 AM
...
<html lang="en">
    ...
    <%
        ...
        int eventPollId = Integer.parseInt(request.getParameter("id"));
        EventPollItemDAO eventPollItemDAO = new EventPollItemDAOImpl();
        List<EventPollItem> eventPollItemList = eventPollItemDAO.retrieveAllEventPollItemByEventPollId(eventPollId);
    %>
    <body class="bg-gray-100 font-family-karla flex">
                ...
                <main class="w-full flex-grow p-6">
                    <div class="flex justify-between">
                        <div>
                            ...
                            <a class="text-3xl text-blue-500 pb-6 hover:underline" href="EventResult.jsp?eventid=<%=eventid%>">Poll Lists</a>
                            <span class="text-3xl text-black pb-6 mx-3"> / </span>
                            <a class="text-3xl text-black pb-6">Poll Result</a>
                        </div>
                        <div>
                    ...
                    <%
                        ...
                        EventPoll eventPoll = eventPollDAO.retrieveEventPollByPollId(eventPollId);
                    %>  
                                ...
                                <tbody class="text-gray-700">
                                    <%                                        
                                        ...
                                        for (EventPollItem eventPollItem1 : eventPollItemList) {
                                            int eventPollItemId = eventPollItem1.getPolleventitemid();
                                            ResultDAO resultDAO1 = new ResultDAOImpl();
                                            List<Result> listResult = resultDAO1.retrieveResultsByPollEventItemId(eventPollItemId);
                                    ...
                                    <tr>
                                        ...
                                        <td class="w-1/3 text-left py-3 px-4"><%=result.getDatetime()%></td>
                                    </tr>
                                    <%
                                            counter++;
                                        }
        ...
        <script>
            ...
            <%
                ...
                for (EventPollItem eventPollItem : eventPollItemList) {
                    int count = resultDAO.countResultByPollEventItemId(eventPollItem.getPolleventitemid());
            %>
            <%=count%>,
            <%
                }
