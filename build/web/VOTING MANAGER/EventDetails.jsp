<%-- 
    Document   : EventOverview1
    Created on : Jun 5, 2021, 8:12:26 AM
...
<html lang="en">
    <head>
        ...
        <title>Event Overview | Voting Rush</title>
            ...
            <div class="w-full h-screen overflow-x-hidden border-t flex flex-col justify-between">
                <main class="w-full p-6">
                    <div class="flex">
                        ...
                        <h1 class="text-3xl text-black pb-6">Event Overview</h1>
                    </div>
                            ...
                            <div class="w-full leading-loose">
                                <div class="px-10 pt-5 pb-10 bg-white rounded shadow-xl">
                                    <div class="flex justify-end items-center">
                                        <a href="EventEditForm.jsp?id=<%=selectedEvent.getEventid()%>" class="px-4 py-1 text-white font-light tracking-wider bg-gray-900 rounded hover:bg-gray-200">
                                        ...
                                        <form action="<%=request.getContextPath()%>/EventController" method="POST">
                                            ...
                                            <button type="submit" name="action" value="delete" class="px-4 py-1 text-red-700 font-light tracking-wider hover:bg-gray-200 rounded hover:text-red-700 focus:outline-white hover:bg-gray-200">
                                    ...
                                    <div>
                                        <%
                                            ...
                                            Organization organization = organizationDAO.retrieveOrganizationByOrganizationId(selectedEvent.getOrganizationid());
                                        %>
                                        <table class="mt-5 w-full text-left border-collapse border border-gray-500">
                                            <tr>
                                                <th class="border border-gray-500 p-4"><label>Event Name</label></th>
                                                <td class="border border-gray-500 pl-4"><%=selectedEvent.getEventName()%></td>
                                            </tr>
                                            <tr>
                                                <th class="border border-gray-500 p-4"><label>Target Audience</label></th>
                                                <td class="border border-gray-500 pl-4"><%=organization.getOrganizationName()%></td>
                                            </tr>
                                            <tr>
                                                <th class="border border-gray-500 p-4"><label>Organized By</label></th>
                                                <td class="border border-gray-500 pl-4"><%=selectedEvent.getOrganizedBy()%></td>
                                            </tr>
                                            <tr>
                                                <th class="border border-gray-500 p-4"><label>Event Location</label></th>
                                                <td class="border border-gray-500 pl-4"><%=selectedEvent.getEventLocation()%></td>
                                            </tr>
                                            <tr>
                                            ...
                                            <tr>
                                                <th class="border border-gray-500 p-4"><label>Even Description</label></th>
                                                <td class="border border-gray-500 pl-4"><%=selectedEvent.getEventDesc()%></td>
                                            </tr>          
                                        </table>
                                    </div>
                                </div>
                    ...
                    <div class="w-full mt-12">
                        <div class="flex">
                            ...
                            <div class="ml-5 ">
                                <a href="PollForm.jsp?eventid=<%=selectedEvent.getEventid()%>" class="flex items-center px-4 py-1 text-white font-light tracking-wider bg-gray-900 rounded hover:bg-gray-200">
                        ...
                        <div class="mt-5 bg-white overflow-auto">
                                    ...
                                    <tr>
                                        <td class="px-5 py-5 border-b border-gray-200 bg-white text-sm">
                                            <div class="flex items-center">
                                                <a class="hover:text-blue-500 hover:underline" href="EventPollDetails.jsp?eventpollid=<%=eventPoll.getPollEventId()%>&eventid=<%=eventid%>">
