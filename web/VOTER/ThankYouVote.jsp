<%-- 
    Document   : ThanYouVote
    Created on : Jun 1, 2021, 12:32:09 PM
    ...
    <body>
        <section class="pb-20 relative block bg-gray-900">
            ...
            <div class = "mr-auto ml-auto text-center">
                ...
                <a href="<%=request.getContextPath()%>/GENERAL PAGES/LiveVoteCount.jsp?eventid=<%=eventid%>" class="ml-3 bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-20 rounded">
                    Live Vote Count
                </a>
                <br><br><br><br>
            </div>
