<%-- 
    Document   : EventForm
    Created on : Jun 1, 2021, 12:29:47 PM
...
<html lang="en">
    <head>
        ...
        <title>Event Form | Voting Rush</title>
                    ...
                    <div class="flex justify-center mt-20 mb-32">
                        <div class="flex grid bg-white rounded-lg shadow-xl w-11/20 md:w-9/20 lg:w-1/2">
                            <div class="flex justify-center mx-5">
                                <div class="mt-5 flex">
                                    <h1 class="text-gray-600 font-bold md:text-2xl text-xl">Event Form</h1>
                                </div>
                            </div>
                            <form action="<%=request.getContextPath()%>/EventController" method="POST">
                                <%
                                ...
                                <div class="grid grid-cols-1 mx-7">
                                    ...
                                    <input name="eventName" class="py-1 px-3 rounded-lg border-2 border-blue-300 mt-1 focus:outline-none focus:ring-2 focus:ring-blue-600 focus:border-transparent" type="text" placeholder="E.g.: Election of SRC for UMT" />
                                </div>

                                <div class="grid grid-cols-1 mt-5 mx-7">
                                    <label class="uppercase md:text-sm text-xs text-gray-500 text-light font-semibold">Organized By</label>
                                    <input name="organizedBy" class="py-1 px-3 rounded-lg border-2 border-blue-300 mt-1 focus:outline-none focus:ring-2 focus:ring-blue-600 focus:border-transparent" type="text" placeholder="E.g.: Suruhanjaya Pilihan Raya" />
                                </div>

                                <div class="grid grid-cols-1 mt-5 mx-7">
                                    <label class="uppercase md:text-sm text-xs text-gray-500 text-light font-semibold">Event location</label>
                                    <input name="eventLocation" class="py-1 px-3 rounded-lg border-2 border-blue-300 mt-1 focus:outline-none focus:ring-2 focus:ring-blue-600 focus:border-transparent" type="text" placeholder="E.g.: Online" />
                                </div>
                                ...
                                <div class="grid grid-cols-1 mt-5 mx-7">
                                    <div x-data="app()" x-init="initDate();" x-cloak>
                                        ...
                                        <div class="relative" @keydown.escape="closeDatepicker()" @click.away="closeDatepicker()">
                                            ...
                                            <input name="startDate" type="text" @click="endToShow = 'from'; initDate(); showDatepicker = true" x-model="dateFromValue" class="py-1 px-3 rounded-lg border-2 border-blue-300 mt-1 focus:outline-none focus:ring-2 focus:ring-blue-600 focus:border-transparent" />
                                            <div class="inline-block px-2 h-full">to</div>
                                            <input name="endDate" type="text" @click="endToShow = 'to'; initDate(); showDatepicker = true" x-model="dateToValue" class="py-1 px-3 rounded-lg border-2 border-blue-300 mt-1 focus:outline-none focus:ring-2 focus:ring-blue-600 focus:border-transparent" />
                                ...
                                <div class="grid grid-cols-1 mt-5 mx-7">
                                    ...
                                    <input name="eventDesc" class="py-5 px-3 rounded-lg border-2 border-blue-300 mt-1 focus:outline-none focus:ring-2 focus:ring-blue-600 focus:border-transparent" type="textarea" placeholder="Enter your description here." />
                                </div>
                                ...
                                <div class="grid grid-cols-1 mt-5 mx-7">
                                    <%
                                        ...
                                        Department department = departmentDAO.retrieveById(departmentid);
                                        OrganizationDAO organizationDAO = new OrganizationDAOImpl();
                                        Organization organization = organizationDAO.retrieveOrganizationByOrganizationId(department.getOrganizationid());
                                    %>
                                    <label for="organization">Who is this for?</label>
                                    <select class="py-5 px-3 rounded-lg border-2 border-blue-300 mt-1 focus:outline-none focus:ring-2 focus:ring-blue-600 focus:border-transparent" name="organization" id="organization">
                                        <option value="<%=organization.getOrganizationId()%>">
                                            <%=organization.getOrganizationName()%>
                                        </option>
                                        <%
                                             Organization organization1 = organizationDAO.retrieveOrganizationByOrganizationId(3);
                                        %>
                                        <option value="<%=organization1.getOrganizationId()%>">
                                            <%=organization1.getOrganizationName()%>
                                        </option>
                                    </select>
                                </div>

                                <div class='flex items-center justify-center  md:gap-8 gap-4 pt-5 pb-5'>
                                    <button type="submit" name="action" value="saveEvent" class='w-auto bg-gray-500 hover:bg-gray-700 rounded-lg shadow-xl font-medium text-white px-4 py-2'>Save</button>
                                    <a class="w-auto bg-blue-500 hover:bg-blue-700 rounded-lg shadow-xl font-medium text-white px-4 py-2" href="Dashboard.jsp">Cancel</a>
                                </div>
