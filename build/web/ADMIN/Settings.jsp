<%-- 
    Document   : Settings
    Created on : Jul 9, 2021, 5:49:43 AM
    Author     : USER
--%>
...
<html lang="en">
    <head>
        ...
        <title>Admin Settings | Voting Rush</title>
    ...
    <body class="bg-gray-100 font-family-karla flex">
        ...
        <aside class="relative bg-sidebar h-screen w-64 hidden sm:block shadow-xl">
            ...
            <nav class="text-white text-base font-semibold pt-3">
                ...
                <a href="Settings.jsp" class="flex items-center active-nav-link text-white py-4 pl-6 nav-item">
        ...
        <div class="relative w-full flex flex-col h-screen overflow-y-hidden">
            ...
            <header x-data="{ isOpen: false }" class="w-full bg-sidebar py-5 px-6 sm:hidden">
                ...
                <nav :class="isOpen ? 'flex': 'hidden'" class="flex flex-col pt-4">
                    ...
                    <a href="Message.jsp" class="flex items-center text-white opacity-75 hover:opacity-100 py-2 pl-4 nav-item">
                        <i class="fas fa-envelope mr-3"></i>
                        Messages
                    </a>
                    <a href="Settings.jsp" class="flex items-center active-nav-link text-white py-2 pl-4 nav-item">
                        <i class="fas fa-table mr-3"></i>
                        Settings
                    </a>
                                ...
                                <div class="px-10 pt-5 pb-10 bg-white rounded shadow-xl">
                                    <div class="flex justify-between mb-3">
                                        ...
                                        <div class=" flex justify-between">     
                                            <a href="AdminEditProfile.jsp" class="px-4 py-1 text-white font-light tracking-wider bg-gray-900 rounded hover:bg-gray-700">
                                    ...
                                    <div>
                                        <table class="text-left">
                                            <tr>
                                                <th>Email</th>
                                                <td class="pl-4">: <%=admin.getEmail()%></td>
                                            </tr>
                                            <tr>
                                                <th>Password</th>
                                                <td class="pl-4">: <%=admin.getPassword()%></td>
                                            </tr>
                                        </table>
                                    </div>
                                </div>
