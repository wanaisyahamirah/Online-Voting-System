<%-- 
    Document   : Message
    Created on : Jul 10, 2021, 5:32:21 AM
    Author     : Hp
--%>
...
<html lang="en">
    <head>
        ...
        <title>Message | Voting Rush</title>
        ...
        <div class="w-full flex flex-col h-screen overflow-y-hidden">
            ...
            <header x-data="{ isOpen: false }" class="w-full bg-sidebar py-5 px-6 sm:hidden">
                ...
                <nav :class="isOpen ? 'flex': 'hidden'" class="flex flex-col pt-4">
                    ...
                    <a href="Message.jsp" class="flex items-center active-nav-link text-white opacity-75 hover:opacity-100 py-4 pl-6 nav-item">
                        <i class="fas fa-envelope mr-3"></i>
                        Messages
                    </a>
            ...
            <div class="w-full h-screen overflow-x-hidden border-t flex flex-col justify-between">
                <main class="w-full flex-grow p-6">
                    <h1 class="text-3xl text-black pb-6">Messages</h1>

                    <!-- Content goes here! 😁 -->
                    <div class="w-full mt-12">
                        <p class="text-xl pb-3 flex items-center">
                            <i class="fas fa-list mr-3"></i> Message Lists
                        </p>
                                    ...
                                    <tr>
                                        <td class="px-5 py-5 border-b border-gray-200 bg-white text-sm">
                                            <div class="flex items-center">
                                                <p class="text-gray-900 whitespace-no-wrap">
                                                    <a class="hover:text-blue-500 hover:underline" href="MessageDetails.jsp?id=<%=contact.getId()%>"><%=contact.getFullname()%></a>
                                                </p>
                                            </div>
                                        </td>
                                        <td class="px-5 py-5 border-b border-gray-200 bg-white text-sm">
                                        ...
                                        <td class="px-5 py-5 border-b border-gray-200 bg-white text-sm">
                                            <div class=" flex justify-between">
                                                <a href="MessageDetails.jsp?id=<%=contact.getId()%>" class="flex items-center px-4 py-1 text-white font-light tracking-wider bg-gray-900 rounded hover:bg-gray-700" type="submit">
                                                ...
                                                <form action="<%=request.getContextPath()%>/adController" method="POST">
