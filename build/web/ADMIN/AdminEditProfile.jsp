<%-- 
    ...
    Created on : Jul 9, 2021, 8:14:27 PM
    Author     : Hp
--%>
...
<body class="bg-gray-100 font-family-karla flex">
    ...
    <aside class="relative bg-sidebar h-screen w-64 hidden sm:block shadow-xl">
            ...
            <nav class="text-white text-base font-semibold pt-3">
                ...
                <a href="AdminEditProfile.jsp" class="flex items-center text-white opacity-75 hover:opacity-100 py-4 pl-6 nav-item">
        ...
        <div class="relative w-full flex flex-col h-screen overflow-y-hidden">
            ...
            <header x-data="{ isOpen: false }" class="w-full bg-sidebar py-5 px-6 sm:hidden">
                ...
                <nav :class="isOpen ? 'flex': 'hidden'" class="flex flex-col pt-4">
                    ...
                    <a href="AdminEditProfile.jsp" class="flex items-center text-white opacity-75 hover:opacity-100 py-2 pl-4 nav-item">
                        <i class="fas fa-cogs mr-3"></i>
                        Settings
                    </a>
                        ...
                        <div class="w-full leading-loose">
                            <div>
                                <form class="px-10 pt-5 pb-10 bg-white rounded shadow-xl" action="../vmController">
                                    ...
                                    <div>
                                        <div>
                                            <input class="w-full border rounded" type="hidden" name="hidid" value="<%=admin.getId()%>">
                                        </div>
                                    </div>
                                    <div>
                                        <div>
                                            <label class="mt-4 block text-s text-gray-900" for="email"><b>Full Name:</b></label>
                                            <input class="px-2 w-full border rounded" type="text" name="email" size="50" value="<%=admin.getEmail()%>">
                                        </div>
                                    </div>
                                    <div>
                                        <div>
                                            <label class="mt-4 block text-s text-gray-900" for="password"><b>Password:</b></label>
                                            <input class="px-2 w-full border rounded" type="password" name="password" size="30" value="<%=admin.getPassword()%>">
                                        </div>
                                    </div>
                                </form>
                            </div>
