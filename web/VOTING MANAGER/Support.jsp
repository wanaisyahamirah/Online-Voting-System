<%-- 
    Document   : Support
    Created on : Jun 5, 2021, 1:34:35 AM
...
<head>
    ...
    <title>Support | Voting Rush</title>
    <meta name="author" content="David Grzyb">
    <meta name="description" content="">
    <script src="https://use.fontawesome.com/f3e0578f1e.js"></script>
    <!-- Tailwind -->
...
<body class="bg-gray-100 font-family-karla flex">
    ...
    <aside class="relative bg-sidebar h-screen w-64 hidden sm:block shadow-xl">
        ...
        <nav class="text-white text-base font-semibold pt-3">
            ...
            <a href="Support.jsp" class="flex items-center active-nav-link text-white py-4 pl-6 nav-item">
            ...
            <main class="w-full flex-grow p-6">
                ...
                <div class="w-full mt-12">
                    <p class="text-xl pb-3 flex items-center">
                        <i class="fa fa-users mr-3"></i> <a class="hover:text-blue-500 hover:underline" href="<%=request.getContextPath()%>/GENERAL PAGES/LandingPage.jsp">About Us</a>
                    </p>
                </div>
                <div class="w-full mt-3">
                    <p class="text-xl pb-3 flex items-center">
                        <i class="fa fa-phone mr-3"></i> <a class="hover:text-blue-500 hover:underline" href="<%=request.getContextPath()%>/GENERAL PAGES/ContactPage.jsp">Help Centre</a>
                    </p>
                </div>
                <div class="w-full mt-3">
                    <p class="text-xl pb-3 flex items-center">
                        <i class="fa fa-laptop mr-3"></i><a class="hover:text-blue-500 hover:underline" href="<%=request.getContextPath()%>/GENERAL PAGES/DemoPage.jsp">Demo</a>
                    </p>
                </div>
                <div class="w-full mt-3">
                    <p class="text-xl pb-3 flex items-center">
                        <i class="fas fa-shield-alt mr-3"></i> <a class="hover:text-blue-500 hover:underline" href="<%=request.getContextPath()%>/GENERAL PAGES/PrivacyPolicy.jsp">Privacy & Policy</a>
                    </p>
                </div>
                <div class="w-full mt-3">
                    <p class="text-xl pb-3 flex items-center">
                        <i class="fa fa-pencil-alt mr-3"></i> <a class="hover:text-blue-500 hover:underline" href="<%=request.getContextPath()%>/GENERAL PAGES/TermsCondition.jsp">Terms & Condition</a>
                    </p>
                </div>
            </main>
