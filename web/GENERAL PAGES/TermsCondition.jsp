<%-- 
    Document   : TermsCondition
    Created on : Jun 5, 2021, 1:22:29 AM
    Author     : LENOVO
--%>
...
<html>
    <head>
        ...
        <title>Terms & Conditions | Voting Rush</title>
    </head>
    <body>
        ...
        <div class="overflow-hidden bg-gray-900 -mt-32 pt-32">
            <header class="relative z-10 text-center text-gray-300 max-w-2xl px-4 sm:px-3 mx-auto pt-16 sm:pt-24 xl:pt-32 pb-14 lg:pb-20 xl:pb-28">
                <h1 class="text-3xl sm:text-5.5xl font-extrabold tracking-tight text-white mb-4">Terms & Conditions</h1>
                <p class="text-lg max-w-auto mx-auto mb-8">XXX</p>
                
            </header>
            <div class="relative bg-gray-300 border-t border-gray-50 border-opacity-10 mt-3 px-4 sm:px-6 lg:px-10 pb-14 lg:pb-20 xl:pb-28">
